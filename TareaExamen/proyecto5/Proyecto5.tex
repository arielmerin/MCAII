...
\begin{align*}
	\dfrac{df}{dx}(xy) &= y &&\text{Por la regla del producto}\\
	\dfrac{df}{dy}(xy) &= x &&\text{Por la regla del producto}\\
...
entonces calculemos las siguientes derivadas
\begin{align*}
	\dfrac{df}{dx}(e^{xy}) &= ye^{xy} &&\text{Por la regla de la exponencial}\\
	\dfrac{df}{dy}(e^{xy}) &= xe^{xy} &&\text{Por la regla de la exponencial}\\
